...
class AIResponses (commands .Cog ):
    ...
    async def on_message (self ,message ):
        ...
        if not content :
            ...
            title ="💕 Hey there!",
            description =(
            f"Hi sweetie! I'm **Samaksh Core**, your caring Discord companion! ✨\n\n"
            ...
            embed .set_footer (text ="Made with love bysamaksh-core 💕")
        ...
        embed .set_footer (text ="Powered bysamaksh-core")
        await message .reply (embed =embed ,mention_author =True )
